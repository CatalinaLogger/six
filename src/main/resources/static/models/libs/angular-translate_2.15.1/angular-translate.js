...
function $translateSanitizationProvider () {
   ...
   * @param {string} mode - either 'text' for a string (translation) or 'param' for the interpolated param
  ...
  this.$get = ['$injector', '$log', function ($injector, $log) {
    ...
    return {
       ...
       * @param {string} mode The current sanitization mode, either 'param' or 'text'.
...
function $translateDefaultInterpolation ($interpolate, $translateSanitization) {
   ...
   *
   * @description
   * Interpolates given value agains given interpolate param using angulars
   * `$interpolate` service.
   *
   * Since AngularJS 1.5, `value` must not be a string but can be anything input.
   *
   * @param {string} value translation
   * @param {object} interpolationParams interpolation param
    ...
    compile: function (tElement, tAttr) {
      ...
      return function linkFn(scope, iElement, iAttr) {
        ...
        var initInterpolationParams = function (interpolateParams, iAttr, tAttr) {
          ...
          // initially fetch all attributes if existing and fill the param
